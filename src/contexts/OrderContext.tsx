...
export const OrderProvider = ({ children }: Props) => {
  ...
  const createOrder = (address: string,
    ...
    const newOrder = { orderNumber, products, address, email, name, city, postalcode, phonenumber }; // Create the order object with the generated order number, products, and delivery address
